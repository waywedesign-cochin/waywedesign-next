...
import logo from '@/images/backgrounds/christmaslogo.png'
                    ...
                    <div className="footer-widget__column footer-widget__about">
                      ...
                      <Link target={"_blank"} href="https://wa.me/+917994643673">
                        ...
                        <Link target={"_blank"} href="https://twitter.com/waywedesign">
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512"  fill='white' className='x-twitter' onmouseover='black'><path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"/></svg>
                          </div>
                        </Link>
                    ...
                    <div className="footer-widget__column footer-widget__contact">
                      ...
                      <ul className="list-unstyled footer-widget__contact-list">
                        ...
                        <li>
                          ...
                          <div className="text">
                            <p>
                              <a className="fw-light" href="tel:+917994645676">+91 799 464 5676</a>
                            </p>
                          </div>
                        </li>
                      </ul>
                      <ul className="list-unstyled footer-widget__contact-list">
                        ...
                        <li>
                          ...
                          <div className="text">
                            <p>
                              <a className="fw-light" href="tel:+917994643780">+91 799 464 3780</a>
                            </p>
                          </div>
                        </li>
                      </ul>
